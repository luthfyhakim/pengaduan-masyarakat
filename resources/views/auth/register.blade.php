    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-input id="nik" class="block mt-1 w-full" type="text" name="nik" :value="old('nik')" placeholder="NIK" required autofocus />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" placeholder="Email mu" required />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-input id="phone" class="block mt-1 w-full" type="text" name="phone" :value="old('phone')" placeholder="No handphone" required />
            </div>
